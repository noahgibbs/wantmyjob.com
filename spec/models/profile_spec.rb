...
describe "a profile with two jobs" do
  subject do
    j1 = Factory.create(:job)
    j2 = Factory.create(:job, :profile_id => j1.profile)
    j1.profile
  end
  ...
  context "and one question and no answers" do
    ...
    it "should have 66% odds of a company question" do
      question # create this
      questions, answers, odds = subject.next_question_odds
      (odds - 0.66666).abs.should < 0.0001
    end
  end
  ...
  context "and one question and a perfect company answer" do
    ...
    it "should have 100% odds of a company-answer next" do
      question; answer
      qs, as, odds = subject.next_question_odds
      (odds - 1.0).abs.should <= 0.0001
    end
